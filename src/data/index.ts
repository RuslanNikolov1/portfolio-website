...
export const skills: Skill[] = [
  ...
  // Design Skills
  { name: 'Client-focused problem solving', level: 95, category: 'design', notes: 'Redesigned Ambra\'s reservation flow to reduce friction. Solved 3D navigation challenges for Forest Residence Sofia to help buyers visualize properties.' },
  { name: 'Leadership and mentoring', level: 92, category: 'design', notes: 'Established front-end standards across projects. Mentored juniors on AMTP Association app with code reviews and pair programming. Led DefiLlama dashboard architecture decisions.' },
  { name: 'Effective communication', level: 90, category: 'design', notes: 'Facilitated stakeholder meetings for Forest Residence Sofia, translating technical requirements into clear specifications. Presented solutions to clients ensuring business-goal alignment.' },
  { name: 'Strategic project planning', level: 88, category: 'design', notes: 'Orchestrated DefiLlama dashboard from concept to deployment. Created roadmaps and managed resources across concurrent projects. Delivered portfolio and 8+ prototypes within tight deadlines.' },
  { name: 'Problem-Solving & Critical Thinking', level: 95, category: 'design', notes: 'Resolved DefiLlama dashboard state management issues. Debugged Three.js performance bottlenecks for Forest Residence Sofia. Optimized AGB Finance mortgage flow based on user behavior analysis.' },
  { name: 'Adaptability & Continuous Learning', level: 92, category: 'design', notes: 'Mastered Three.js and Framer Motion for Forest Residence Sofia\'s 3D experiences. Adopted Web Audio API for interactive sound design. Integrated AI-assisted development tools for enhanced productivity.' },
  { name: 'Time Management & Prioritization', level: 90, category: 'design', notes: 'Delivered 9 portfolio projects within aggressive timelines through effective scoping. Managed concurrent client projects while maintaining code quality. Reduced delivery time by 30% with optimized workflows.' },
  { name: 'Attention to Detail', level: 88, category: 'design', notes: 'Crafted pixel-perfect responsive designs across all projects. Implemented accessibility features for AMTP Association app. Achieved 95+ Lighthouse scores through performance optimization.' },
  { name: 'Empathy & User-Centric Mindset', level: 90, category: 'design', notes: 'Designed intuitive architecture for AMTP Association, making transport policies accessible. Created user-friendly mortgage flows for AGB Finance. Conducted user research for Ambra\'s improved reservation UX.' },
  { name: 'Collaboration in Agile Teams', level: 88, category: 'design', notes: 'Worked with designers, PMs, and stakeholders in sprint cycles. Participated in standups and planning for DefiLlama dashboard. Collaborated with 3D artists for Forest Residence Sofia\'s technical feasibility.' },
  { name: 'Mentorship & Knowledge Sharing', level: 85, category: 'design', notes: 'Created documentation and reusable component libraries. Conducted knowledge transfer on React patterns and TypeScript. Established coding standards that improved team productivity by 40%.' }
];
