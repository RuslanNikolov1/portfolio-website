...
export const skills: Skill[] = [
  ...
  { name: 'Mapbox', level: 75, category: 'frontend' },
  { name: 'Web Audio API', level: 70, category: 'frontend' },
  { name: 'Three.js', level: 75, category: 'frontend' },
  { name: 'REST API', level: 88, category: 'frontend' },
  { name: 'GraphQL', level: 75, category: 'frontend' },
  { name: 'Git', level: 90, category: 'frontend' },
  { name: 'CI/CD', level: 85, category: 'frontend' },
  { name: 'Webpack', level: 80, category: 'frontend' },
  { name: 'Vite', level: 85, category: 'frontend' },
  { name: 'AI-assisted Development', level: 90, category: 'frontend' },
  ...
  { name: 'Empathy & User-Centric Mindset', level: 90, category: 'design' },
